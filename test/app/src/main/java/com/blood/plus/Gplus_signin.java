 ...
 */
public class Gplus_signin extends FragmentActivity implements
...
//    mCirclesListView.setAdapter(mCirclesAdapter);
  ...
  //  Log.i("dob", currentUser.getBirthday());
   ...
   //     .setResultCallback(this);
    ...
    data.putExtra("name", currentUser.getDisplayName());
    data.putExtra("email",email);
    data.putExtra("gender", currentUser.getGender());
    data.putExtra("age", String.valueOf(currentUser.getAgeRange()));
